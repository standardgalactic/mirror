...
const ENTRY_CSS = "./assets/index-5b4ba2c8.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-927dbe6c.js').then(n => n.I),true?["./Index-927dbe6c.js","./Index-8834d140.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-17ccf342.js.map
